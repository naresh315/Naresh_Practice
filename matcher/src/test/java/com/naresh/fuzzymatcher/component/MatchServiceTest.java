...
public class MatchServiceTest {
    ...
    public void itShouldApplyMatchByDocId() {
        String[][] input = {
          		 {"bhabat", "naresh bhabat co llc " },
                 {"shlok", "bhabat naresh limited " },
                 {"shlok", "shlok  bhabat" },
                 {"shlok", "shlok" },
    ...
    public void itShouldApplyMatchByGroups() {
        String[][] input = {
          		 {"bhabat", "naresh bhabat ltd" },
                 {"shlok", "bhabat naresh co ltd" },
                 {"shlok", "shlok  bhabat" },
                 {"shlok", "shlok" },
    ...
    @Test
    public void itShouldApplyMatchForMultiplePhoneNumber1() {
