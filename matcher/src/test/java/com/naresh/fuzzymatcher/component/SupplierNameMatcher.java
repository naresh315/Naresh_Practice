package com.naresh.fuzzymatcher.component;
...
import com.naresh.fuzzymatcher.domain.ElementType;
import com.naresh.fuzzymatcher.domain.Match;
import com.naresh.fuzzymatcher.function.PreProcessFunction;
...
import static com.naresh.fuzzymatcher.domain.ElementType.*;


/**
 *
 */
public class SupplierNameMatcher {
    private static final Logger LOGGER = LoggerFactory.getLogger(SupplierNameMatcher.class);
    ...
    public void itShouldApplyMatchByDocId() {
        String[][] input = {
                {"1", "nqwqwqwaresh bhabat", "35952 north valley court michigan"},
                {"2", "bqw	qwhabat nare	qwsh", "35952 N valley court"},
                {"3", "shlok bhabat", "35952 north valley court michigan"}
        };
    ...
    public void itShouldApplyMatchByGroups() {
        String[][] input = {
                {"1", "Steqwqwven Wilsaon", "45th Avenue 5th st."},
    ...
    public static CSVReader getCSVReader(String FileName) throws FileNotFoundException {
        return new CSVReaderBuilder(
                new FileReader(SupplierNameMatcher.class.getClassLoader().getResource(FileName).getFile()))
                .withSkipLines(1)
                .build();
    }
